...
urlpatterns = [
    ...
    path('select-domain/', views.select_domain, name='select_domain'),
    path('university/', views.uni_home, name='uni_home'),
    path('university/courses/', views.uni_courses, name='uni_courses'),
    path('university/books/', views.uni_books, name='uni_books'),
